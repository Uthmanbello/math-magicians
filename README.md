...
**[Math Magicians]** is a project that uses a Single Page Application format to display items on a page. A user can switch to a page where a live calculator which can be used for computation is.
...
- [Live Demo Link](https://math-magicians-3rc8.onrender.com/)
